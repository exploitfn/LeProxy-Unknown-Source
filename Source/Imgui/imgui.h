...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsRed(ImGuiStyle* dst = NULL); // classic imgui style
    ...
    IMGUI_API void        Particles(ImDrawList* d, ImVec2 b);// draw a small circle and keep the cursor on the same line. advance cursor x position by GetTreeNodeToLabelSpacing(), same distance that TreeNode() uses
